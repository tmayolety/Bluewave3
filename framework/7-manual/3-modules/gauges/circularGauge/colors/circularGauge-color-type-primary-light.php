<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-primary-light">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-primary-light" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-primary-light').dxCircularGauge({
