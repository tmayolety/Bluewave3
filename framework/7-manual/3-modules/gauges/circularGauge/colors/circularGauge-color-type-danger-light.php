<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-danger-light">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-danger-light" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-danger-light').dxCircularGauge({
