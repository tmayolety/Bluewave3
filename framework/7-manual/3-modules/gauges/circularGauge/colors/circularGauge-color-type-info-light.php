<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-info-light">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-info-light" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-info-light').dxCircularGauge({
