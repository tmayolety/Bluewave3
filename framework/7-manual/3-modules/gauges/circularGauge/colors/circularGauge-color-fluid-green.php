<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-fluid-green">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-fluid-green" class="circularGauge"></div>				<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-fluid-green').dxCircularGauge({
