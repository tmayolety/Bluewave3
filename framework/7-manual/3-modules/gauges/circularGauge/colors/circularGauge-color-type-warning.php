<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-warning">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-warning" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-warning').dxCircularGauge({
