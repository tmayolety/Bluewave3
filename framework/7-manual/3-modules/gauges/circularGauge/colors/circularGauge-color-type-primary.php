<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-primary">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-primary" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-primary').dxCircularGauge({
