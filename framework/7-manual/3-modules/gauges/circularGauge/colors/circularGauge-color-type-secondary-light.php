<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-secondary-light">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-secondary-light" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-secondary-light').dxCircularGauge({
