<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-info">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-info" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-info').dxCircularGauge({
