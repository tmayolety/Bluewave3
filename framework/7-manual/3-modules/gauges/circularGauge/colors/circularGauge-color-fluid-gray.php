<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-fluid-gray">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-fluid-gray" class="circularGauge"></div>				<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-fluid-gray').dxCircularGauge({
