<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-warning2">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-warning2" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-warning2').dxCircularGauge({
