<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-secondary-dark">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-secondary-dark" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-secondary-dark').dxCircularGauge({
