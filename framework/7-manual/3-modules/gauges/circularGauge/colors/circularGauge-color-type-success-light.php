<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-success-light">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-success-light" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-success-light').dxCircularGauge({
