<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-fluid-yellow">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-fluid-yellow" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-fluid-yellow').dxCircularGauge({
