<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-secondary">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-secondary" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-secondary').dxCircularGauge({
