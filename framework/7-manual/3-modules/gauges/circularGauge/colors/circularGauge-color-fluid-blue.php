<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-fluid-blue">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-fluid-blue" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-fluid-blue').dxCircularGauge({
