<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-type-danger">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-color-type-danger" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-color-type-danger').dxCircularGauge({
