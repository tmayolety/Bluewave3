<div class="circularGauge-wrapper w-sm-270 h-sm-150 status-fluid-brown">												<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-fluid-brown" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
...
$(document).ready(function () {
	$('#circularGauge-fluid-brown').dxCircularGauge({
