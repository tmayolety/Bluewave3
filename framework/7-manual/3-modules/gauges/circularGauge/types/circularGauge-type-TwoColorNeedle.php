<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-150">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-type-TwoColorNeedle" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-type-TwoColorNeedle').dxCircularGauge({
	...
	valueIndicator: {		
		...
		spindleGapSize:0,
		spindleSize:15,
		secondColor:"RGBA(var(--clr-neutralgray) / 20%",
		color:"yellow",
