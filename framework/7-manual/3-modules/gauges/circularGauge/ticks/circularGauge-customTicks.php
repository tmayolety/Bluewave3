<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-150">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-customTicks" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-customTicks').dxCircularGauge({
	...
	scale: {
		...
		scaleDivisionFactor: 10,
		customTicks: [0, 30, 60, 200],
		customMinorTicks: [5, 10, 15, 50],
		tick: {
