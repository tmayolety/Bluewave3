<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-150">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-menorticks3" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-menorticks3').dxCircularGauge({
	...
	scale: {
		...
		minorTick: {
			...
			length:4,										/* <?=$menorTickLength;?> */
			visible:true,									/* <?=$menorTickVisible;?> */		
			width:1	
		},
		label: {
