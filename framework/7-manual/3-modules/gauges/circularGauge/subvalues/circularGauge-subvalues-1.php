<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-150">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-subvalues-1" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-subvalues-1').dxCircularGauge({
	...
	subvalueIndicator: {
		...
		length:10,											/* <?=$subvaluesLenght;?> */
		offset: 0,											/* <?=$subvaluesOffset;?> */
		palette: [
			"var(--value-yellow)",
			"var(--value-red)"
		],
