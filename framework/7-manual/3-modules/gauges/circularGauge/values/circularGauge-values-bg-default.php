<div class="circularGauge-wrapper status-type-primary value-bg-default w-sm-300 h-sm-150">							<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-values-bg-default" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-values-bg-default').dxCircularGauge({
