<div class="circularGauge-wrapper status-type-success">									<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-quarter" class="circularGauge w-sm-300 h-sm-300"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>
