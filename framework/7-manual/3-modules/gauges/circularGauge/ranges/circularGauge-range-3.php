<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-150">
	<div id="circularGauge-range-3" class="circularGauge"></div>
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-range-3').dxCircularGauge({
	...
	rangeContainer: {
		...
		ranges: [
			...
			{ startValue: 40, endValue: 160, color: 'RGBA(var(--clr-type-success) / 100%)' },
