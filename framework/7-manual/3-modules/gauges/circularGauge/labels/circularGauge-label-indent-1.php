<div class="circularGauge-wrapper status-type-primary w-sm-250 h-sm-150">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-label-indent-1" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-label-indent-1').dxCircularGauge({
