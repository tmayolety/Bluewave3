<div class="circularGauge-wrapper status-type-primary w-sm-150 h-sm-150">									<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-quarter-lt" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-quarter-lt').dxCircularGauge({
