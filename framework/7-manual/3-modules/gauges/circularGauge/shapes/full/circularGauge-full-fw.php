<div class="circularGauge-wrapper status-type-primary w-sm-300 h-sm-300">										<!-- <?=$gaugestatus;?> -->
	<div id="circularGauge-full-fw" class="circularGauge"></div>		<!-- <?=$gaugeId;?> <?=$gaugeWidth;?> <?=$gaugeHeight;?> -->
</div>


<script language="JavaScript">
$(document).ready(function () {
	$('#circularGauge-full-fw').dxCircularGauge({
